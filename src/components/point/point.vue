...
export default {
  ...
  data() {
    return {
      // cityData:"/static/data/cityData.json",
      // testdata:"/static/data/point/testData.json",
      legendArr: [],
  ...
  methods: {
    ...
    _getCityData() {
      // debugger
      // this.$https.get("/static/data/cityData.json").then(res => {
      //   this.geoCoordMap = res.data;
      //   this.$nextTick(() => {
      //     this._getMyChart();
      //   });
      // });
      this.geoCoordMap = cityData.data;
        this.$nextTick(() => {
          this._getMyChart();
        });
    },
          ...
          series: [
            {
              ...
              data: this.convertData(testdata.data)
            },
            {
              name: "标签2",
              type: "scatter",
